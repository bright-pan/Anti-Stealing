...
{
#if OS_APP_HOOKS_EN > 0 && OS_TASK_CREATE_HOOK_EN > 0
...
{
#if OS_APP_HOOKS_EN > 0 && OS_TASK_DEL_HOOK_EN > 0
...
{
#if OS_APP_HOOKS_EN > 0 && OS_TASK_IDLE_HOOK_EN > 0
    App_TaskIdleHook();
#endif
}
#endif
...
{
#if OS_APP_HOOKS_EN > 0 && OS_TASK_STAT_HOOK_EN > 0
    App_TaskStatHook();
#endif
}
#endif
...
{
#if OS_APP_HOOKS_EN > 0 && OS_TCB_INIT_HOOK_EN > 0
